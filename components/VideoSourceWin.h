...
class VideoSourceWinCallback : public VideoCapture::VideoFrameCallback
{
public:
...
protected:
    VideoCapture::VideoCaptureDeviceManager mDeviceManager;
    VideoCapture::VideoCaptureDevice mCaptureDevice;
    VideoCapture::RGBVideoFormat mVideoFormat;

    nsAutoPtr<VideoSourceWinCallback> cb;
